...
ถ้า Agent รู้เองว่ายังมีจุดตกหล่น, งานค้าง, regression risk หรือสิ่งที่ยังไม่ได้ทำตามแผน
ห้ามสรุปเหมือนงานเสร็จสมบูรณ์เด็ดขาด ให้ระบุในหัวข้อ `สิ่งที่ควรทำต่อ` ทันทีอย่างชัดเจน
และถ้าเป็นงานที่ควรเก็บต่อได้ในรอบเดียว Agent ควรลงมือเก็บต่อเลย ไม่โยนกลับให้ผู้ใช้มาทวง
